...
function submitOrder() {
    ...
    $.ajax({
        url: `http://${serverName}:8080/api/orders`,
        type: "POST",
...
function start() {   
    ...
    $('#loginBtn').click(function (e) {
        ...
        $.ajax({
            url: `http://${serverName}:8080/api/user/login`,
            type: "POST",
            contentType: "application/json",
    ...
    function loadProducts() {
        $('#productList').empty();
        $.ajax({
            url: `http://${serverName}:8080/api/products`,
            type: "GET",
            dataType: "json",
...
function showOrders() {
    ...
    `);
    $.ajax({
        url: `http://${serverName}:8080/api/orders/`+sessionStorage.getItem("username"),
        type: "GET",
        dataType: "json",
...
function showDetails(orderid){
    ...
    `);
    $.ajax({
        url: `http://${serverName}:8080/api/orders/orderid/`+orderid,
        type: "GET",
        dataType: "json",
...
function showItemDetails(orderid) {
    ...
    `);
    $.ajax({
        url: `http://${serverName}:8080/api/items/`+orderid,
        type: "GET",
        dataType: "json",
